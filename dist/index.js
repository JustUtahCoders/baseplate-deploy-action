/******/ (() => {
  ...
  /******/ var __webpack_modules__ = {
    ...
    /***/ 931: /***/ function (__unused_webpack_module, exports) {
      "use strict";
    ...
    /***/ 180: /***/ (module, __webpack_exports__, __nccwpck_require__) => {
      "use strict";
      __nccwpck_require__.a(
        ...
        async (
          ...
          try {
            ...
            /* harmony import */ var _baseplate_sdk_cli__WEBPACK_IMPORTED_MODULE_1__ =
              __nccwpck_require__(149);

            try {
              await baseplateCLI.deploy({
                baseplateToken: core.getInput("baseplate-token"),
                dir: core.getInput("upload-dir"),
                entry: core.getInput("entry-file"),
                environmentName: core.getInput("environment-name"),
                microfrontendName: core.getInput("microfrontend-name"),
              });
            } catch (err) {
              console.error(err);
    ...
    /***/ 270: /***/ (module) => {
      module.exports = eval("require")("./cli-utils");
    ...
    /***/ 149: /***/ (
      ...
      "use strict"; // CONCATENATED MODULE: ./node_modules/.pnpm/@baseplate-sdk+utils@3.1.2/node_modules/@baseplate-sdk/utils/lib/orgSettings.js

      // UNUSED EXPORTS: deploy
      ...
      function orgSettings_mergeDefaultOrgSettings(orgSettings) {
        var finalSettings = mergeWith(
          {},
          defaultSettings,
          orgSettings,
      ...
      } // CONCATENATED MODULE: ./node_modules/.pnpm/@baseplate-sdk+utils@3.1.2/node_modules/@baseplate-sdk/utils/lib/main.js

      // EXTERNAL MODULE: external "path"
      var external_path_ = __nccwpck_require__(17);
      // EXTERNAL MODULE: external "fs"
      var external_fs_ = __nccwpck_require__(147); // CONCATENATED MODULE: external "fs/promises"
      const promises_namespaceObject = require("fs/promises");
      // EXTERNAL MODULE: ./node_modules/.pnpm/@vercel+ncc@0.36.1/node_modules/@vercel/ncc/dist/ncc/@@notfound.js?./cli-utils
      var _notfoundcli_utils = __nccwpck_require__(270); // CONCATENATED MODULE: ./node_modules/.pnpm/@baseplate-sdk+cli@1.0.1/node_modules/@baseplate-sdk/cli/lib/js-api.js
      async function deploy(args) {
        ...
        const customerOrgResponse = await baseplateFetch(`/api/orgs/me`);
        const { id: customerOrgId, orgKey } = customerOrgResponse;
        const partialOrgSettings = await baseplateFetch(
          `/api/orgs/${customerOrgId}/static-web-settings`
        );
        const orgSettings = mergeDefaultOrgSettings(partialOrgSettings);
        const proxySettings =
        ...
        const { microfrontends } = await baseplateFetch(
        ...
        if (proxySettings.useBaseplateHosting) {
          const deploymentCredentials = await baseplateFetch(
      ...
      async function recurseDir(allFiles, dir, includeParentDirInPath) {
